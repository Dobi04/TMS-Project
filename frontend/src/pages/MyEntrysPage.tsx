export default function MyEntrysPage() {
  return (
    <section className="border-t-4 border-[#f5c400] bg-white p-8 shadow-[0_12px_30px_rgba(24,59,112,0.08)]" aria-label="My entrys page">
      ...
      <p className="mt-4 text-base text-slate-600">This is my entrys page.</p>
    </section>
  );
}
